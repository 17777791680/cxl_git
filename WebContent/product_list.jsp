		...
		<table width="100%" border="0" cellspacing="0">
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>计算机</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${page.totalRecord }种商品
								<hr />
			...
			<c:forEach items="${page.result }" var="b">							
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td ><a
										href="${pageContext.request.contextPath }/BookServlet?methodName=delBook&id=${b.id}" onclick="return tishi()">
										<script type="text/javascript">
											function tishi(){
												return confirm("确定要删除改图书吗？")
												}
								...
								<div class="pagination">
									<ul>
										<li class="nextPage"><a href="${pageContext.request.contextPath }/BookServlet?methodName=findByPage&pageNum=${page.pageNumber==1?1:page.pageNumber-1}">&lt;&lt;上一页</a></li>
										
										<li>第${page.pageNumber }页/共${page.totalPage }页</li>

										<li class="nextPage"><a href="${pageContext.request.contextPath }/BookServlet?methodName=findByPage&pageNum=${page.pageNumber==pb.totalPage?page.totalPage:page.pageNumber+1}">下一页&gt;&gt;</a></li>
									</ul>
								</div></td>
						</tr>
					</table>
